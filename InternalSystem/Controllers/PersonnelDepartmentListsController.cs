...
namespace InternalSystem.Controllers
{
    ...
    public class PersonnelDepartmentListsController : ControllerBase
    {
        ...
        {
            if (id != personnelDepartmentList.DepId)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<PersonnelDepartmentList>> PostPersonnelDepartmentList(PersonnelDepartmentList personnelDepartmentList)
        {
            ...
            {
                if (PersonnelDepartmentListExists(personnelDepartmentList.DepId))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetPersonnelDepartmentList", new { id = personnelDepartmentList.DepId }, personnelDepartmentList);
        }
        ...
        {
            return _context.PersonnelDepartmentLists.Any(e => e.DepId == id);
        }
    }
}
